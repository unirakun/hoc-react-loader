...
`tinycolor2` is a peer dependency of `hoc-react-loader`, it handle color picking for the default loading indicator. You don't have to install it if you use your own loading indicator.
